    ...
    public partial class createDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Autherized", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Autherized_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Autherized_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Autherized_GroupId",
                table: "Autherized",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Autherized_RoleId",
                table: "Autherized",
                column: "RoleId");
